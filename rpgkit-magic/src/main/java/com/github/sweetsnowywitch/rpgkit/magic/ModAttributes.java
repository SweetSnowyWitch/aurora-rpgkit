...
public class ModAttributes {
    ...
    public static final EntityAttribute MANA_REGEN_SPEED = make("mana_regen_speed", 0.01, 0, 1);
    public static final EntityAttribute MANA_HEALTH_FACTOR = make("mana_health_factor", 1, 0, 10);
